            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[...Array(9)].map((_, i) => (
                <div key={i} className="bg-white rounded-2xl border border-gray-100 overflow-hidden">
                  {/* Image placeholder */}
                  <div className="skeleton-line w-full" style={{height: '200px', borderRadius: '0'}}></div>
                  {/* Content */}
                  <div className="p-4 space-y-2">
                    <div className="skeleton-line h-4 w-3/4"></div>
                    <div className="skeleton-line h-3 w-1/2"></div>
                    <div className="skeleton-line h-3 w-2/3 mt-1"></div>
                    <div className="skeleton-line h-8 w-1/3 mt-3" style={{borderRadius: '20px'}}></div>
                  </div>
                </div>
              ))}
            </div>
          ) : recipes.length > 0 ? (
            <div className="recipe-reveal grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {recipes.map((recipe) => (
